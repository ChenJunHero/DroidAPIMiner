...
from androguard_v2.core.bytecodes import jvm
from androguard_v2.core.bytecodes import dvm
from androguard_v2.core.bytecodes import apk
from androguard_v2.core.analysis import analysis
        ...
        for i in self.__files :
            ...
            if ".class" in i :
                ...
                if ret_type == "APK" :
                    ...
                    from androguard_v2.core.binaries import elf
