...
def load_api_specific_resource_module(resource_name, api):
    ...
    from external_api_calls.androguard.core.api_specific_resources.aosp_permissions import AOSP_PERMISSIONS
    from external_api_calls.androguard.core.api_specific_resources.api_permission_mappings import AOSP_PERMISSIONS_MAPPINGS
