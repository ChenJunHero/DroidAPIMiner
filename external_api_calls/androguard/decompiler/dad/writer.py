...
from external_api_calls.androguard.decompiler.dad.instruction import (
...
class Writer(object):
    ...
    # ('METHOD', 'sendToServer', 'this -> sendToServer', <androguard_version3.1.decompiler.dad.instruction.ThisParam>)
